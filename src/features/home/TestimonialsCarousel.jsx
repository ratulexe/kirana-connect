...
const TESTIMONIALS = [
  { name: 'Priya Sharma', city: 'Bengaluru', rating: 5, text: 'Finally found which shop near me has the Amul butter I need! Saved me so much guesswork on busy mornings.', gradient: 'from-pink-400 to-violet-500', emoji: '👩' },
  { name: 'Rahul Mehta', city: 'Mumbai', rating: 5, text: 'Compared prices across 4 kirana stores before stepping out. Saved ₹45 on my weekly grocery run!', gradient: 'from-orange-400 to-pink-500', emoji: '👨' },
  { name: 'Anita Nair', city: 'Chennai', rating: 5, text: 'The search is lightning fast. Typed "atta" and got results from 6 nearby stores instantly.', gradient: 'from-teal-400 to-blue-500', emoji: '👩💼' },
  { name: 'Deepak Kumar', city: 'Delhi', rating: 5, text: 'My neighbourhood kirana store got more customers after listing on Kirana Connect. This is the future!', gradient: 'from-yellow-400 to-orange-500', emoji: '🧑🏫' },
  { name: 'Sneha Patel', city: 'Ahmedabad', rating: 5, text: 'Love how I can browse by mood — found exactly what I needed for chai time without wandering around.', gradient: 'from-green-400 to-teal-500', emoji: '👩🎤' },
  { name: 'Arjun Singh', city: 'Pune', rating: 5, text: 'The flash deals are incredible. Grabbed Maggi noodles 24% off before the deal ended. Brilliant!', gradient: 'from-indigo-400 to-purple-500', emoji: '🧑💻' },
];
        ...
        <div className="relative mx-auto max-w-2xl">
          <div key={active} className="glass-card rounded-panel p-8 text-center animate-slide-up">
            ...
            <div className="mt-6 flex flex-col items-center gap-2">
              <div className={`size-12 rounded-full bg-gradient-to-br ${t.gradient} flex items-center justify-center text-2xl shadow-lg`}>{t.emoji}</div>
              <div>
