...
function CategoryCard({ category, index }) {
  return (
    <Link
      ...
      className="glass-card hologram card-lift group flex h-full min-w-[10.5rem] flex-col justify-between gap-4 rounded-card p-4 transition-[border-color,box-shadow,transform] duration-200 ease-brand hover:-translate-y-1 hover:border-primary/35 hover:shadow-float sm:min-w-0"
    >
      <Tilt3DCard className="flex h-full flex-col justify-between gap-4">
        <div>
