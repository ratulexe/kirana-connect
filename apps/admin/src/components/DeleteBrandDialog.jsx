...
export default function DeleteBrandDialog({ brand, onClose, onConfirm, isPending, error }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      ...
      >
        ...
        <p className="mt-2 text-body text-ink-muted">
          Products using this brand will become unbranded. This action cannot be undone.
        </p>
